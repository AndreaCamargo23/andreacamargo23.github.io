...
const fieldsModel = {
  ...
  tasaInteres: '',
  anticipadaOrigen: false,
  anticipadaDestino: false,
};
...
const ConversionesComponent:React.FC = () => {
  ...
  const submitConversionTasa = (e: FormEvent) => {
    ...
    const result = convertirTasasDeInteres(parseFloat(fields.tasaInteres), fields.modalidadInteresOrigen, fields.modalidadInteresDestino, fields.anticipadaOrigen, fields.anticipadaDestino);
      ...
      <div className="flex flex-wrap">
            ...
            >   
                ...
                <div className="form-control w-full max-w-xs py-3">
                    ...
                    <div>
                        <input type="checkbox" name="anti-ingreso" id="anti-in"
                        onClick={(e) => setFields({...fields, anticipadaOrigen: e.target.checked})}/>
                        <label for="anti-in" className="label-text">Anticipada</label>
                    </div>
                </div>
                ...
                <div className="form-control w-full max-w-xs py-3">
                    ...
                    <div>
                        <input type="checkbox" name="anti-salida" id="anti-sal" onClick={(e) => setFields({...fields, anticipadaDestino: e.target.checked})}/>
                        <label for="anti-sal" className="label-text">Anticipada</label>
                    </div>
                </div>
                <div className="">
                    <button className="btn btn-active btn-dark">
                        Convertir
                    </button>
                </div>
            </form>
