      ...
      <div className="flex flex-wrap">
          ...
          <div className="container p-3">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="form-control w-full max-w-xs py-3 px-3">
                ...
                />
                <label className="label">
                  <span className="label-text-alt text-sky-900">El valor de la deuda no puede estar en blanco o ser negativo.</span>
                </label>
              </div>
              ...
              <div className="form-control w-full max-w-xs py-3 px-3">
                ...
                />
                <label className="label">
                  <span className="label-text-alt text-sky-900">El número de pagos debe estar entre 1 y 1000.</span>
                </label>
              </div>
              ...
              <div className="form-control w-full max-w-xs py-3 px-3">
                ...
                <label className="label">
                  <span className="label-text-alt text-sky-900">Seleccione una opción válida.</span>
                </label>
              </div>
              ...
              <div className="form-control w-full max-w-xs py-3 px-3">
                ...
                ></input>
                <label className="label">
                  <span className="label-text-alt text-sky-900">La tasa de interes es requerida.</span>
                </label>
              </div>
            </div>
            ...
            {/* Botón: Mostrar Tabla */}
            <div className="">
              <button className="btn btn-active btn-dark btn-block">Mostrar tabla de amortización</button>
            </div>
          </div>
        </form>
        ...
        <div className="basis-2/4">
          {tablaAmortizacion.length > 0 && (
            <>
              <h3 className="my-3 text-gray-700"><b>TABLA DE AMORTIZACIÓN</b></h3>
