      ...
      <div className="flex flex-wrap">
          ...
          <div className="container p-3">
            <div className="grid grid-cols-2 gap-4">
              <div className="form-control w-full max-w-xs py-3 px-3">
                ...
                />
                <label className="label">
                  <span className="label-text-alt text-sky-900">
            ...
            <div className="">
              <button className="btn btn-active btn-dark btn-block">Mostrar tabla de capitalización</button>
            </div>
          </div>
        </form>
        ...
        <div className="basis-2/4">
          {tablaCapitalizacion.length > 0 && (
            <>
              <h3 className="my-3 text-gray-700"><b>TABLA DE CAPITALIZACIÓN</b></h3>
